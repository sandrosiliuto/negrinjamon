...
export default function CalidadSection() {
  return (
    <section id="calidad" className="relative py-32 px-6">
      <SectionHeader
        ...
        {features.map((f, i) => (
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-negrin-sand/70 leading-relaxed">{f.desc}</p>
      ...
      <div className="max-w-4xl mx-auto mt-20 text-center">
        <motion.div
          ...
          className="p-8 rounded-2xl bg-white/[0.02] border border-negrin-gold/20"
        >
          <blockquote className="text-2xl md:text-3xl font-light leading-snug font-display">
          ...
          <div className="mt-6 text-negrin-warm text-sm tracking-widest">
            — FAMILIA NEGRÍN
          </div>
        </motion.div>
      </div>
